...
$statements = [
    ...
    "CREATE TABLE IF NOT EXISTS hw3 . Reviews (id INT NOT NULL AUTO_INCREMENT, title VARCHAR(50) NOT NULL, post LONGTEXT NOT NULL, genreId INT NOT NULL, date DATE NOT NULL DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY (id)) ENGINE = InnoDB"
];
